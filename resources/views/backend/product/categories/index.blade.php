                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <label class="aiz-switch aiz-switch-success mb-0">
                                ...
                                <input type="checkbox" onchange="update_is_home(this)" value="{{ $category->id }}" <?php if($category->is_home == 1) echo "checked";?>>
...
@section('script')
    ...
    <script type="text/javascript">
        ...
        function update_is_home(el){
            ...
            $.post('{{ route('categories.is_home') }}', {_token:'{{ csrf_token() }}', id:el.value, status:status}, function(data){
                if(data == 1){
                    AIZ.plugins.notify('success', '{{ translate('Home categories updated successfully') }}');
                }
                else{
                    AIZ.plugins.notify('danger', '{{ translate('Something went wrong') }}');
                }
