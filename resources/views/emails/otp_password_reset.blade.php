                                        ...
                                        <tr>
                                            <td style="padding:40px 30px 20px 30px; text-align:center;">
                                                ...
                                                <div style="font-size:15px; line-height:22px; color:#5c6470; padding-bottom:28px;">
                                                    {{ translate('Enter this code to reset your password on') }} {{ env('APP_NAME') }}.
                                                </div>
                                            </td>
                                        </tr>
                                        <tr>
                                        ...
                                        <tr>
                                            <td style="padding:0 30px 40px 30px; text-align:center;">
                                                <div style="font-size:13px; line-height:20px; color:#8a92a0;">
                                                    {{ translate('This code will expire in 10 minutes. If you did not request a password reset, you can safely ignore this email.') }}
                                                </div>
                                            </td>
                                        </tr>
                                    </table>
