...
$col_values = ((get_setting('vendor_system_activation') == 1) || addon_is_activated('delivery_boy')) ? "col-lg-3
                ...
                <div class="text-center text-sm-left mt-4">
                    ...
                    <ul class="list-unstyled">
                        ...
                        <li class="mb-2">
                            ...
                            <p class="fs-13 text-dark mb-0">
                                ...
                                <a href="{{ route('shops.create') }}" class="fs-13 fw-700 text-secondary-base ml-2">{{
                        ...
                        <li class="mb-2">
                            ...
                            <a class="fs-13 text-dark animate-underline-white" href="{{ route('seller.login') }}">
                    ...
                    <ul class="list-unstyled">
                        ...
                        <li class="mb-2">
                            ...
                            <a class="fs-13 text-dark animate-underline-white" href="{{ route('deliveryboy.login') }}">
...
{{-- text-lg-left --}}
                <div class="text-center fs-14 pb-3 pb-lg-0" current-verison="{{get_setting(" current_version")}}">
        ...
        <div class="col">
            ...
            <a href="{{ route('categories.all') }}"
                ...
                <span
                    ...
                    class="d-block mt-1 fs-10 fw-600 text-reset {{ areActiveRoutes(['categories.all'],'text-primary')}}">{{
        ...
        <div class="col">
            ...
            <a href="{{ route('all-notifications') }}"
                ...
                <span
                    ...
                    class="d-block mt-1 fs-10 fw-600 text-reset {{ areActiveRoutes(['all-notifications'],'text-primary')}}">{{
