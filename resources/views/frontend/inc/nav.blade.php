...
{{-- <div class="bg-[#3D98D1] py-2 text-center">
    <p class="text-gray-200 text-sm">
        🚚 Free delivery in Phnom Penh |
        <span class="text-cyan-400 font-semibold">078 333 016</span> |
        Cambodia's #1 Online Construction Mall |
        <span class="text-yellow-400 font-bold">Open 24/7</span>
    </p>
</div> --}}
        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-lg-12 col">
                    ...
                    <ul class="lang_head list-inline d-flex justify-content-end justify-content-lg-end mb-0">
                        ...
                        @if (get_setting('show_language_switcher') == 'on')
                            ...
                            <li class="list-inline-item dropdown" id="lang-change">
                                <a href="javascript:void(0)" class="lang_active dropdown-toggle text-secondary fs-12 py-2"
                                    ...
                                    @foreach (get_all_active_language() as $key => $language)
                                        <li>
                                            <a href="javascript:void(0)" data-flag="{{ $language->code }}"
                                                class=" @if ($system_language->code == $language->code) active @endif">
