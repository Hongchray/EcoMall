                    ...
                    <div class="p-3">
                        ...
                        <div class="row d-none">
                            ...
                            <div class="col-md-10">
                                ...
                                <div class="mb-3">
{{-- aiz-selectpicker --}}
                                    <select id="country_id" class="form-control aiz-selectpicker rounded-0" data-live-search="true" data-placeholder="{{ translate('Select your country') }}" name="country_id">

                                        {{-- <option value="">{{ translate('Select your country') }}</option> --}}

                                        @foreach (get_active_countries() as $key => $country)

                                            <option class="selected active" value="{{ $country->id }}">{{ $country->name }}</option>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-10">
                                ...
                                <input type="text" class="form-control mb-3 rounded-0" name="phone" value="" required>
 {{-- placeholder="{{ translate('+880')}}" --}}
                            </div>
