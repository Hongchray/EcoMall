...
<div class="modal-body px-4 py-5 c-scrollbar-light">
    ...
    <div class="row gutters-5">
        <div class="col-sm-6">
            <button type="button" class="js-back-to-shopping btn btn-secondary-base mb-3 mb-sm-0 btn-block rounded-0 text-white" data-dismiss="modal">{{ translate('Back to shopping')}}</button>
        </div>
        <div class="col-sm-6">
